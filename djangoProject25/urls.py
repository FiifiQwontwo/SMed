"""
URL configuration for djangoProject25 project.
...
urlpatterns = [
    ...
    path('groupmembership/', include('membership.urls'), name='members'),
    path('follow/', include('followers.urls'), name='followers'),
